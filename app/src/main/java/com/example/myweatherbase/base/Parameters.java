...
public class Parameters {
    ...
    public final static String BY_CITY_1 = "http://api.openweathermap.org/geo/1.0/direct?q=";
    public final static String BY_CITY_2 = "&limit=1&appid=" + API;

    public final static String CURRENT_1 = "https://api.openweathermap.org/data/2.5/weather?units="+UNITS+"&lang="+LANG;
    public final static String CURRENT_2 = "&appid="+API;
